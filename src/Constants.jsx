...
* First off, you want to write your MD document in a base64, you can use the [editor](MDParser/#/editor) or a Base64 formatter like [this](https://amp.base64encode.org/) one.
...
I'll upgrade this tool so it'll be flexible and fun to use, but for now thank you for using it! 😀`,
    ...
    defaultEdit: `
# Hello, World!
You can type here and your text appears in \`Markdown\` [here](MDParser/#/on_the_right)!`,
    on_the_right: `
# on_the_right
Yes, the parsed text will appear on this box! Go back [here](MDParser/#/editor) to check it out yourself!`
};
